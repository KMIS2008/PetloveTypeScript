...
export default function Main() {
    ...
    return (_jsxs(ContainerMain, { children: [_jsx(Svg, { onClick: () => navigator('home'), children: _jsx("use", { xlinkHref: sprite + '#icon-logo' }) }), _jsxs("picture", { children: [_jsx("source", { media: "(min-width: 1280px)", sizes: "(min-width: 1280px) 100vw, 1280px", srcSet: `
            ${MainDesktop1} 1x,
            ${MainDesktop2} 2x,
            ${MainDesktop3} 3x
          ` }), _jsx("source", { media: "(min-width: 768px)", sizes: "(min-width: 768px) 100vw, 768px", srcSet: `
            ...
            ${MainTablet2} 2x,
            ${MainTablet3} 3x
          ` }), _jsx("source", { media: "(min-width: 375px)", sizes: "(min-width: 375px) 100vw, 375px", srcSet: `
            ${MainMobile1} 1x,
            ${MainMobile2} 2x,
            ${MainMobile3} 3x
          ` }), _jsx("source", { media: "(min-width: 320px)", sizes: "(min-width: 320px) 100vw, 320px", srcSet: `
            ...
            ${MainMobile2} 2x,
            ${MainMobile3} 3x
          ` }), _jsx("img", { src: MainMobile1, srcSet: `
            ${MainMobile1} 1x,
            ${MainMobile2} 2x,
            ${MainMobile3} 3x
